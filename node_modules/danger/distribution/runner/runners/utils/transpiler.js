...
exports.dirContains = function (rootDir, dir) {
...
exports.lookupTSConfig = function (dir) {
    ...
    if (!exports.dirContains(rootDir, dir)) {
        filepath = filename;
    ...
    do {
        ...
        dir = path.dirname(dir);
    } while (exports.dirContains(rootDir, dir));
    return null;
};
exports.typescriptify = function (content, dir) {
    var ts = require("typescript"); // tslint:disable-line
    // Support custom TSC options, but also fallback to defaults
    var compilerOptions;
    var tsConfigPath = exports.lookupTSConfig(dir);
    if (tsConfigPath) {
...
exports.default = (function (code, filename) {
    ...
    if (hasNativeTypeScript && filetype.startsWith(".ts")) {
        result = exports.typescriptify(code, path.dirname(filename));
    }
